...
"""
- печать всего списка по данным из словарей
- при печати используются функции:
> anon_card - преобразование номера карты
> anon_check - преобразование номера счета
- функция print_result не возвращает значений
"""
